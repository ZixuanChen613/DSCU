...
import cont_assoc.models.dsu4d_128_models as models
...
def create_dirs(test_set):
    results_dir = join('/storage/ukp/work/chen_e/dscu_1000', 'output', 'val', 'dsu4d', 'sequences')
    if test_set:
        results_dir = join('/storage/ukp/work/chen_e/dscu_1000', 'output', 'test', 'dsu4d', 'sequences')
