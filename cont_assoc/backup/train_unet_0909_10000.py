...
import cont_assoc.models.unet_models_pos_encoder_10000 as models
...
def main(config, weights):    
    ...
    tb_logger = pl_loggers.TensorBoardLogger('/storage/ukp/work/chen_e/experiments/pos_enc_cu/'+cfg.EXPERIMENT.ID,          
