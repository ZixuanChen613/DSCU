...
import cont_assoc.models.unet_models_train_aq_loss_20000 as models
...
def main(config, weights):    
    ...
    tb_logger = pl_loggers.TensorBoardLogger('/storage/ukp/work/chen_e/experiments/aq_20000/'+cfg.EXPERIMENT.ID,
