...
def create_dirs(test_set):
    results_dir = join('/storage/ukp/work/chen_e/dscu_pos', 'output', 'val', 'dsu4d', 'sequences')
    if test_set:
        results_dir = join('/storage/ukp/work/chen_e/dscu_pos', 'output', 'test', 'dsu4d', 'sequences')
