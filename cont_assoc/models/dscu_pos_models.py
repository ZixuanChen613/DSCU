...
import cont_assoc.models.unet_models_pos as u_models
...
class DSU4D(LightningModule):
    ...
    def get_ins_feat(self, x, ins_pred, raw_features):          
        ...
        if len(coordinates) != len(ins_ids):
            ...
            new_feats, new_coors, new_grid_coordinates = cont.fix_batches_pos(ins_ids, features, coordinates, grid_coordinates)       # need to modify
